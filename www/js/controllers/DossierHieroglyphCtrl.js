adil.controller('DossierHieroglyphCtrl', function($scope, $ionicModal, $timeout, $stateParams, $http, $rootScope) {
    ...
    $scope.learned = function() {
    	console.log("return learned", $rootScope.userData.user_id);
    	console.log("return learned", $stateParams.id_hieroglyph);
         $http.get($rootScope.hostAdress + 'learned/' + $rootScope.userData.user_id + '/' + $stateParams.id_hieroglyph, {
            }).success(function(data) {
                $scope.learned = data;
